...
field=tk.Text(window, height=2, width=29, font=("Times New Roman", 20))
field.grid(row=0, column = 0, columnspan=5)


#Number Buttons

btn0 = tk.Button(window, text="0", command=lambda: addToField(0), width = 5, font = ("Times New Roman", 14))
btn0.grid(row=1, column = 0, pady = 10)
